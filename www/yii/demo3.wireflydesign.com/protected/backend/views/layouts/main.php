	...
	'items' => array(
		array(
			...
			'items' => array(
				...
				array('label' => 'News', 'url' => 'https://plugin.wireflydesign.com/blog/backend.php/site/demo3Direct', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
				 array('label' => 'Mailer', 'url' => 'https://plugin.wireflydesign.com/mailer/backend.php/site/demo3Direct', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
