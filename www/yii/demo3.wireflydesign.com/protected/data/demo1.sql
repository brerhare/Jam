...
--
-- Host: localhost    Database: demo1_wireflydesign_com
-- ------------------------------------------------------
...
INSERT INTO `jelly_slider_image` VALUES (2,1,10,'shell sand','shell.jpg','http://demo1.wireflydesign.com/1/?layout=index&page=products'),(3,1,20,'kids sky','children sky.jpg','http://demo1.wireflydesign.com/1/?layout=index&page=galleries'),(4,1,30,'View of Screel','Screel.jpg','http://demo1.wireflydesign.com/1/?layout=index&page=text-blog');
...
INSERT INTO `tab_block` VALUES (1,10,'Recommended','<p></p><p><img src=\"/1/userdata/tab/1771239516.jpg\" style=\"width: 134.66666666666666px; height: 202px; float: right; margin: 0px 0px 10px 10px;\" alt=\"Smoked Salmon\"></p><h1>Recommended Product of the Month</h1>We have just in some smoked salmon, caught on the Solway Coast using the traditional haaf nets&nbsp;<p></p>\r\n',NULL),(2,20,'Most Popular','<p><p><img src=\"/1/userdata/tab/1183367806.jpg\" style=\"width: 247.5px; height: 165px; float: left; margin: 0px 10px 10px 0px;\" alt=\"\"></p>Our venison is proving to be particularly popular with our regular customers.</p>',NULL);
