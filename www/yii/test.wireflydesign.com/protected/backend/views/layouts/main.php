	...
	'items' => array(
		array(
			...
			'items' => array(
				...
				array('label' => 'Product Backend', 'url' => 'https://plugin.wireflydesign.com/product/backend.php/site/testDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
