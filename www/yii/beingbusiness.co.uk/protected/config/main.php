...
return array(
	...
	'components'=>array(
		...
		/**/
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=beingbusiness_co_uk',
			'emulatePrepare' => true,
			'username' => 'beingbusiness.co',
			'password' => '4ffvj7gbv',
			'charset' => 'utf8',
		),
		/**/
	...
	'params'=>array(
		...
		'checkoutEmail'=>'admin@beingbusiness.co.uk',
		'checkoutName'=>'Being Business',
        ...
        // Paypal
        //'checkoutPaypalEmail'=>'jo@beingbusiness.co.uk',

		'jellyRoot' => '/scripts/jelly/',
		'sid' => '4or2l3p5arrdgh1l6rhlfkaqv6',
	),
);
