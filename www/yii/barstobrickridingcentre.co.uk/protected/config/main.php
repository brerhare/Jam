...
return array(
	...
	'name'=>'Barstobrick Riding Centre',
	...
	'components'=>array(
		...
		/**/
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=barstobrickridingcentre_co_uk',
			'emulatePrepare' => true,
			'username' => 'barstobrickridin',
			'password' => '4jk9gdc3',
			'charset' => 'utf8',
		),
		/**/
	...
	'params'=>array(
		...
		'checkoutEmail'=>'barstobrickrc@hotmail.co.uk',
		'checkoutName'=>'Barstobrick Riding Centre',
        ...
        // Paypal
        //'checkoutPaypalEmail'=>'no@email',

		'jellyRoot' => '/scripts/jelly/',
		'sid' => 'urncem1n8arrhmv6e1aaq778h1',
	),
);
