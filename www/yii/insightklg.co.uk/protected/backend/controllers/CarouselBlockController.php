...
class CarouselBlockController extends Controller
{
	...
	{
		$model=new CarouselBlock;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['CarouselBlock']))
		{
			$model->attributes=$_POST['CarouselBlock'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('CarouselBlock');
	...
	{
		$model=new CarouselBlock('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CarouselBlock']))
			$model->attributes=$_GET['CarouselBlock'];
	...
	{
		$model=CarouselBlock::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='carousel-block-form')
		{
