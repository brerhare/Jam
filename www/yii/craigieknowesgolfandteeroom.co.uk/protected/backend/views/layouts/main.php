            ...
            'items' => array(
                ...
                array('label' => 'Plugins', 'url' => '#', 'visible' => !Yii::app()->user->isGuest,
                    'items' => array(
                        ...
                        array('label' => 'Blog', 'url' => 'https://plugin.wireflydesign.com/blog/backend.php/site/craigieknowesDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
