            ...
            'items' => array(
                ...
                array('label' => 'Plugins', 'url' => '#', 'visible' => !Yii::app()->user->isGuest,
                    'items' => array(
                        ...
                        //array('label' => 'Mailer', 'url' => 'https://plugin.wireflydesign.com/mailer/backend.php/site/bryceWalkerVendingDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
