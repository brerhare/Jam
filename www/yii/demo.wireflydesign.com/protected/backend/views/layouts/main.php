	...
	'items' => array(
		array(
			...
			'items' => array(
				...
				array('label' => 'News', 'url' => 'https://plugin.wireflydesign.com/blog/backend.php/site/demoDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
                array('label' => 'Events', 'url' => 'https://plugin.wireflydesign.com/event/backend.php/site/demoDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
