	...
	'items' => array(
		array(
			...
			'items' => array(
				...
				array('label' => 'News', 'url' => 'https://plugin.wireflydesign.com/news/backend.php/site/weetargetDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
				array('label' => 'Product Backend', 'url' => 'https://plugin.wireflydesign.com/product/backend.php/site/weetargetDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
