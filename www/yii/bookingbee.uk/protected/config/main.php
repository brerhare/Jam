...
return array(
	...
	'components'=>array(
		...
		/**/
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=bookingbee_uk',
			'emulatePrepare' => true,
			'username' => 'bookingbee.uk',
			'password' => 'Xik3nac0-',
			'charset' => 'utf8',
		),
		/**/
	...
	'params'=>array(
		...
		'checkoutName'=>'Booking Bee checkout',
        ...
        // Paypal
        //'checkoutPaypalEmail'=>'info@wireflydesign.com',

		'jellyRoot' => '/scripts/jelly/',
		'sid' => 'vfrgt59xsclh63jc94fi5jfhsp',
	),
);
