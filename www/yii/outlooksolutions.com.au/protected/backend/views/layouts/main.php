	...
	'items' => array(
		array(
			...
			'items' => array(
				...
				array('label' => 'News Backend', 'url' => 'https://plugin.wireflydesign.com/news/backend.php/site/outlookDirect', 'visible' => !Yii::app()->user->isGuest),
				array('label' => 'Mailer', 'url' => 'https://plugin.wireflydesign.com/mailer/backend.php/site/outlookDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
