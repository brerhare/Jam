...
<div style="position:absolute; margin-left:25px;margin-top:30px">
...
name="image" width="180" height="228"> </form> <!--kim image width was 200 -->
</div>

            <img src="<?php Yii::app()->request->baseUrl ?> /img/wp65d1b97d_06.png" width="234" height="313" border="0" alt="" onload="OnLoadPngFix()" usemap="#map0" style="position:absolute;left:730px;top:28px;">
            <img src="<?php Yii::app()->request->baseUrl ?> /img/wp984d43e2_06.png" width="334" height="57" border="0" title="" alt="Glitzaratti Couture Design" onload="OnLoadPngFix()" style="position:absolute;left:297px;top:266px;">
            <img src="<?php Yii::app()->request->baseUrl ?> /img/wpc84d212f_06.png" width="427" height="216" border="0" alt="" onload="OnLoadPngFix()" style="position:absolute;left:244px;top:52px;">
            <a href="<?php echo $this->createUrl('site/contact');?>" id="nav_418_B3" class="Button1" style="z-index:1000;display:block;position:absolute;left:765px;top:280px;width:94px;height:37px;"><span style="height:54px; width:123px;font-size:12px;font-weight:bold;
	...
	<div id="footer" text="#000000" style="background-color:#000000; text-align:center; height:253px;">
        <div style="background-color:#000000;text-align:left;margin-left:auto;margin-right:auto;position:relative;width:960px;height:253px;">
            ...
            <div id="txt_1" style="position:absolute;left:0px;top:131px;width:960px;height:82px;overflow:hidden; z-index:1000">
