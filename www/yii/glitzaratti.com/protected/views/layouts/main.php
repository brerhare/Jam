...
<!-- Topmenu -->
<a href="<?php echo $this->createUrl('site/index');?>" id="nav_418_B1" class="Button1" style="z-index:1000;display:block;position:absolute;left:170px;top:5px;width:94px;height:37px;"><span>Hame</span></a>
<a href="<?php echo $this->createUrl('site/sendyourown');?>" id="nav_418_B2" class="Button1" style="display:block;position:absolute;left:275px;top:5px;width:94px;height:37px;"><span>SYO</span></a>
<a href="<?php echo $this->createUrl('product/index?category_id=all');?>" id="nav_418_B3" class="Button1" style="z-index:1000;display:block;position:absolute;left:380px;top:5px;width:94px;height:37px;"><span>Gallery</span></a>
<a href="<?php echo $this->createUrl('site/links');?>" id="nav_418_B4" class="Button1" style="display:block;position:absolute;left:485px;top:5px;width:94px;height:37px;"><span>About Us</span></a>
...
<div style="position:absolute; margin-left:-45px;margin-top:30px">
