...
<h4 class="Header-P"><<p class="Normal-P">Terms & Conditions</p></h4>
<?php echo "<p class='Normal-P'>" . nl2br("
<b>Your Shoes: if using SYO (our supply your own service)</b>
Prior to sending us your shoes, please ensure correct fit and preferred heel height.  Glitzaratti will not be responsible should you discover that they are not suitable after they have undergone our Encrusting Service.   We recommend using Recorded or Special Delivery to ensure the safe delivery of your shoes to us as we except no liability for items lost in the post or damaged upon arrival. We will return your items using a recorded signed for service.

<b>Our shoes</b>
Glitzaratti endeavour to only use the top High quality suppliers of our base shoes which are true to UK sizing measurements. We can supply half sizes and wide fits if required please email us to arrange this.
Please ensure you order your correct size at the time of ordering as once production begins we are unable to swap sizes.

<b>Care Instructions:</b>
- Treat your item with love and care, as you would your favourite party dress or piece of jewellery. Excessive or careless use can result in damage to the encrusting.
