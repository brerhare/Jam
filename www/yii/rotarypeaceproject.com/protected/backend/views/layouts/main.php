            ...
            'items' => array(
                ...
                array('label' => 'Plugins', 'url' => '#', 'visible' => !Yii::app()->user->isGuest,
                    'items' => array(
                        ...
                        //array('label' => 'Events', 'url' => 'https://plugin.wireflydesign.com/event/backend.php/site/rotaryPeaceProjectDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
