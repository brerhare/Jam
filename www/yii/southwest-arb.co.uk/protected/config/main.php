...
return array(
	...
	'components'=>array(
		...
		/**/
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=southwest_arb_co_uk',
			'emulatePrepare' => true,
			'username' => 'southwest-arb.co',
			'password' => 'h2a7jgbx',
			'charset' => 'utf8',
		),
		/**/
	...
	'params'=>array(
		...
		'checkoutEmail'=>'not_set',
		'checkoutName'=>'not_set',
		...
		'sid' => 'd3749rpmr3hr7unmqdvgedlck4',
	),
);
