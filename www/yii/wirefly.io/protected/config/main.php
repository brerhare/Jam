...
return array(
	...
	'components'=>array(
		...
		/**/
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=wirefly_io',
			'emulatePrepare' => true,
			'username' => 'wirefly.io',
			'password' => 'Xik3nac0-',
			'charset' => 'utf8',
	...
	'params'=>array(
		...
		'checkoutEmail'=>'info@wirefly.io',
		'checkoutName'=>'Wirefly checkout',
        ...
        // Paypal
        //'checkoutPaypalEmail'=>'info@wirefly.io',

		'jellyRoot' => '/scripts/jelly/',
		'sid' => '45jdgp2dwfvoptf4s98akpvn2a',
	),
);
