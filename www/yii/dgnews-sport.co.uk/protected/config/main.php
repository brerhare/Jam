...
return array(
	...
	'components'=>array(
		...
		/**/
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=dgnews_sport_co_uk',
			'emulatePrepare' => true,
			'username' => 'dgnews-sport.co.',
			'password' => 'fhs54jqwj86g',
			'charset' => 'utf8',
		),
		/**/
		'errorHandler'=>array(
	...
	'params'=>array(
		...
		'checkoutEmail'=>'info@dgnews-sport.co.uk',
		'checkoutName'=>'DG News Sport',
		// Test gateway
		...
		'sid' => 'f970k853h3fv8qpe0dg2or7a60',
	),
);
