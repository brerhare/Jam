	...
	'items' => array(
		array(
			...
			'items' => array(
				...
				array('label' => 'Mailer', 'url' => 'https://plugin.wireflydesign.com/mailer/backend.php/site/bloodbikesDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
				array('label' => 'News', 'url' => 'https://plugin.wireflydesign.com/news/backend.php/site/bloodbikesDirect', 'linkOptions' => array("target"=>"_blank"), 'visible' => !Yii::app()->user->isGuest),
