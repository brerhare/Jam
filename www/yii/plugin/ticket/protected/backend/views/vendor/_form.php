<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'bank_account_number',array('class'=>'span2','maxlength'=>255)); ?>

	<?php echo $form->textFieldRow($model,'bank_sort_code',array('class'=>'span2','maxlength'=>45)); ?>
