 ...
 * @property string $active_start_date_time
 * @property string $active_end_date_time
...
class Event extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ticket_text, ticket_terms, active_start_date_time, active_end_date_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, uid, title, date, address, post_code, ticket_logo_path, ticket_text, ticket_terms, active, active_start_date_time, active_end_date_time, ticket_vendor_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'active' => 'Active',
			'active_start_date_time' => 'Active Start Date Time',
			'active_end_date_time' => 'Active End Date Time',
	...
	public function search()
	{
		...
		$criteria->compare('active_start_date_time',$this->active_start_date_time,true);
		$criteria->compare('active_end_date_time',$this->active_end_date_time,true);
