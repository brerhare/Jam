...
<br/><br/><br/><br/><br/> <center> <h5>Please wait, redirecting to Paypal...</h5> </center>

<div style="display:none;">
    <form id="pp" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<!--    <form id="pp" action="https://plugin.wireflydesign.com/product/index.php/site/paid?sid=<?php echo Yii::app()->session['sid'];?>" method="post" target="_top"> -->
