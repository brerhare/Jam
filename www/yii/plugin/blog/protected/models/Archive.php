...
/**
 * This is the model class for table "blog_article_archive".
 *
 * The followings are the available columns in table 'blog_article_archive':
 * @property integer $id
