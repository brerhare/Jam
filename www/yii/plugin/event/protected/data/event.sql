...
-- -----------------------------------------------------
-- Table `plugin`.`event_event_has_event_program`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `plugin`.`event_event_has_event_program` ;

CREATE TABLE IF NOT EXISTS `plugin`.`event_event_has_event_program` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `program_id` INT NOT NULL,
  `event_event_id` INT NOT NULL,
