 ...
 * @property TicketArea[] $ticketAreas
 * @property TicketVendor $ticketVendor
 */
class ticket_Event extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ticket_Event the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'ticketAreas' => array(self::HAS_MANY, 'TicketArea', 'ticket_event_id'),
			'ticketVendor' => array(self::BELONGS_TO, 'TicketVendor', 'ticket_vendor_id'),
		);
	}
