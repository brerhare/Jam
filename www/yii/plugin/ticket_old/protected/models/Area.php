...
class Area extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('uid, max_places, ticket_event_id, used_places', 'numerical', 'integerOnly'=>true),
			array('description', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, uid, description, max_places, ticket_event_id, used_places', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('used_places',$this->used_places);
