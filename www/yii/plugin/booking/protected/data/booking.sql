...
-- -----------------------------------------------------
-- Table `booking`.`occupancy_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`occupancy_type` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`facility` ;
...
-- -----------------------------------------------------
-- Table `booking`.`room_has_occupancy_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`room_has_occupancy_type` ;
...
CREATE  TABLE IF NOT EXISTS `booking`.`room_has_occupancy_type` (
  ...
  CONSTRAINT `fk_room_has_occupancy_type_occupancy_type1`
    ...
    REFERENCES `booking`.`occupancy_type` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `booking`.`room_has_facility`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`room_has_facility` ;
...
CREATE  TABLE IF NOT EXISTS `booking`.`room_has_facility` (
  ...
  CONSTRAINT `fk_room_has_facility_facility1`
    ...
    REFERENCES `booking`.`facility` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `booking`.`extra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`extra` ;
...
-- -----------------------------------------------------
-- Table `booking`.`room_has_extra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`room_has_extra` ;
...
-- -----------------------------------------------------
-- Table `booking`.`booking_calendar`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`booking_calendar` ;
...
-- -----------------------------------------------------
-- Table `booking`.`booking_room`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`booking_room` ;
...
-- -----------------------------------------------------
-- Table `booking`.`booking_extra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `booking`.`booking_extra` ;
