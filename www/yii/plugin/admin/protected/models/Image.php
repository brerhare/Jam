...
/**
 * This is the model class for table "admin_image".
 *
 * The followings are the available columns in table 'admin_image':
 * @property integer $id
