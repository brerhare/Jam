...
class MailerMemberController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('MailerMember');
	...
	{
		$model=MailerMember::model()->findByPk($id);
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mailer-member-form')
		{
