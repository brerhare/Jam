...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('opening_hours')); ?>:</b>
	<?php echo CHtml::encode($data->opening_hours); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('slider_image_path')); ?>:</b>
	<?php echo CHtml::encode($data->slider_image_path); ?>
	<br />
